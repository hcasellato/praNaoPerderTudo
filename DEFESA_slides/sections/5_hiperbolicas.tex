...
\begin{frame}{Método upwind: Exemplo do caso unidimensional}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=\textwidth]{img/1D_grafico_pressao_vel.png}
      \caption{Campo de pressões e velocidades do exemplo.}
    \end{figure}
	\end{exemplo}
\end{frame}
	...
	\begin{exemplo}
	  ...
	  \begin{figure}[H]
	    ...
	    \begin{subfigure}[c]{0.32\textwidth}
	      \centering
	      \includegraphics[width=\textwidth]{img/1dVFUW_frames_temp/frame_005.png}
	    \end{subfigure}
	    \begin{subfigure}[c]{0.32\textwidth}
	      \centering
	      \includegraphics[width=\textwidth]{img/1dVFUW_frames_temp/frame_020.png}
	    \end{subfigure}
	    \begin{subfigure}[c]{0.32\textwidth}
	      \centering
	      \includegraphics[width=\textwidth]{img/1dVFUW_frames_temp/frame_035.png}
	    \end{subfigure}

	    \begin{subfigure}[c]{0.32\textwidth}
	      \centering
	      \includegraphics[width=\textwidth]{img/1dVFUW_frames_temp/frame_050.png}
	    \end{subfigure}
	    \begin{subfigure}[c]{0.32\textwidth}
	      \centering
	      \includegraphics[width=\textwidth]{img/1dVFUW_frames_temp/frame_065.png}
	    \end{subfigure}
	    \begin{subfigure}[c]{0.32\textwidth}
	      \centering
	      \includegraphics[width=\textwidth]{img/1dVFUW_frames_temp/frame_080.png}
	    \end{subfigure}
	    \caption{Gráficos de concentração em tempos diferentes.}
	    \label{}
	  \end{figure}
	\end{exemplo}
\end{frame}
...
\begin{frame}{Método upwind: Exemplos do caso bidimensional}
...
\begin{frame}{Método upwind: Exemplos do caso bidimensional}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=.65\textwidth]{img/ex1_painel_6_graficos.png}
      \caption{Painel de dispersão do contaminante para o exemplo.}
    \end{figure}
	\end{exemplo}
\end{frame}
...
\begin{frame}{Método upwind: Exemplos do caso bidimensional}
	\begin{exemplo}
		\centering
		\animategraphics[autoplay,loop,width=0.65\linewidth]{30}{1ex2dVFUW_frames_temp/frame_}{0000}{0100}
	\end{exemplo}
\end{frame}
...
\begin{frame}{Método upwind: Exemplos do caso bidimensional}
    ...
    \begin{figure}[H]
      \centering
      \includegraphics[width=.65\textwidth]{img/ex2_painel_6_graficos.png}
      \caption{Painel de dispersão do contaminante para o exemplo.}
    \end{figure}
	\end{exemplo}
\end{frame}
...
\begin{frame}{Método upwind: Exemplos do caso bidimensional}
	\begin{exemplo}
		\centering
	  \animategraphics[autoplay,loop,width=0.65\linewidth]{30}{2ex2dVFUW_frames_temp/frame_}{0000}{0100}
	\end{exemplo}
\end{frame}

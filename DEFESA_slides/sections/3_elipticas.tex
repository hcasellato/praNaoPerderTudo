...
\begin{frame}{Caso unidimensional: Implementação}
  ...
  \]
  Em contrapartida, quando na face $x_{N+1/2}$, será utilizado \textbf{Contorno de Dirichlet} com pressão imposta
  \[
    \left.p\right|_{x_{N+1/2}} = p_b.
  \]
  Portanto, usando uma discretização com meio volume de controle, a última equação do sistema \eqref{forma_matricial_1d} torna-se:
  \[
...
\begin{frame}{Caso unidimensional: Análise dos métodos de fatoração}

...
% Inclusão das seções
\include{sections/1_definicoesGerais}
\include{sections/2_modelagemEscoamento}
\include{sections/3_elipticas}
\include{sections/4_transporte}
\include{sections/5_hiperbolicas}
\include{sections/6_referencias}

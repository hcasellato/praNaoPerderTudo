...
\subsection{Compressibilidade dos fluidos}
...
\end{equation}
em uma temperatura $T$ fixa. Pela mesma lógica usada para $c_r$, obtém-se
\begin{equation}
  \rho \approx \rho_0(1 + c_f(p - p_0)).
\end{equation}
Os \textit{escoamentos} presentes no reservatório podem ser classiﬁcados como:
\begin{enumerate}[label=\roman*.]
\justifying
\item \textit{Incompressíveis}: possuem compressibilidade zero, o que implica uma massa específica constante independentemente da pressão;
\item \textit{Levemente compressíveis}: possuem uma compressibilidade baixa e constante, com sua massa específica variando linearmente com a pressão; ou
\item \textit{Compressíveis}: possuem compressibilidade alta e sua massa específica cresce com a pressão, tendendo a se estabilizar em altas pressões.
\end{enumerate}
...
\begin{exemplo}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.5\textwidth]{imagens/desenvolvimento_CF_ex2.jpeg}
...
\begin{exemplo}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{imagens/1D_grafico_pressao_vel.png}
...
\begin{exemplo}\label{ex1CB}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.4\textwidth]{imagens/desenvolvimento_2Deliptica_ex2.png}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{imagens/ex1_painel_6_graficos.png}
...
\begin{exemplo}\label{ex2CB}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.7\textwidth]{imagens/ex2_painel_6_graficos.png}
...
\begin{exemplo}\label{ex4CB}
  ...
  \begin{figure}[H]
    \centering
    \includegraphics[width=.6\textwidth]{imagens/ex4_painel_6_graficos.png}

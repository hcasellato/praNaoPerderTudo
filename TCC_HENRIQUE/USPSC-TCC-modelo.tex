...
\newtcolorbox{algobox}[1][]{
  ...
  coltitle=black,
  colback=backcolor,
  colframe=black,       % Moldura preta
  colbacktitle=backcolor,
  title=#1,
  fonttitle=\bfseries,
  boxrule=1pt,
  %left=8mm,  % Adjust left margin
}
...
\renewcommand{\thebibliography}[1]{
    ...
    \justifying % Ativa justificação para todas as entradas
}
...
% Capítulos
% indent = recuo total, numwidth = espaço reservado ao número
\makeatletter
\renewcommand{\l@chapter}[2]{%
  \@dottedtocline{0}{0em}{3em}{\bfseries #1}{\bfseries #2}}
\makeatother

\setlength{\cftpartindent}{0em}   % começa depois do número do capítulo
\setlength{\cftpartnumwidth}{0.5em}

% Seções
\setlength{\cftsectionindent}{3em}   % começa depois do número do capítulo
\setlength{\cftsectionnumwidth}{2.5em}

% Subseções
\setlength{\cftsubsectionindent}{\cftsectionindent+\cftsectionnumwidth}
\setlength{\cftsubsectionnumwidth}{3em}

% Subsubseções
\setlength{\cftsubsubsectionindent}{\cftsubsectionindent+\cftsubsectionnumwidth}
\setlength{\cftsubsubsectionnumwidth}{3em}
